													...
													<div class="tab-content profile-edit-tab-content">
															...
															<div class="row">
																...
																<div class="col-xs-12 col-sm-8">
																	...
																	<div class="form-group">
																		...
																		<div class="col-sm-8">
																			<input class="input-small" type="text" id="form-field-first" placeholder="Prénom" value="Dounia" />
																			<input class="input-small" type="text" id="form-field-last" placeholder="Nom" value="Cherifi" />
																		</div>
																	</div>
																</div>
															</div>
														...
														<div id="edit-settings" class="tab-pane">
															...
															<div>
																<label class="inline">
																	<input type="checkbox" name="form-field-checkbox" class="ace" />
																	<span class="lbl"> M'envoyer un mail à la réception d'une notification</span>
																</label>
															</div>
														</div>
