...
<class>
	...
	<copyright>Copyright ï¿?(C) Manuel Lemos 2004</copyright>
		...
		for ( ; ! $end ; ) {
			if (! IsSet ( $this->credentials [ $key ] )) {
				if (IsSet ( $defaults [ $key ] ))
					$credentials [ $key ] = $defaults [ $key ] ; else {
