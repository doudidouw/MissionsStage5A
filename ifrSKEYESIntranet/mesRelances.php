...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Intranet ifrSKEYES - Mes relances</title>
                ...
                <div class="main-content">
                    ...
                    <div class="breadcrumbs" id="breadcrumbs">
                        ...
                        <ul class="breadcrumb" id="context-nav-bar">
                            ...
                            <li class="active">Mes Relances</li>
                        </ul>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="alert alert-block alert-success">
                                    ...
                                    Retrouvez ici toutes vos relances.
                                </div>

                                <?php include("tableauMesRelances.php"); ?>
                            </div><!-- /.col -->
                        </div><!-- /.row -->
                    </div><!-- /.page-content -->
                </div><!-- /.main-content -->
